    ...
    <table>
        <tr>
            ...
            <td class="auto-style7">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtFirstName0" ErrorMessage="First Name required" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtLastName0" ErrorMessage="Last Name required" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style8">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtEmail0" ErrorMessage="Email required" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style5">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtPassword3" ErrorMessage="Password required" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style1">
            ...
            <td class="auto-style8">
                ...
                <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToCompare="txtPassword4" ControlToValidate="txtPassword3" ErrorMessage="Passwords do not match" ForeColor="Red"></asp:CompareValidator>
            </td>
        </tr>
    </table>
        <br />
